...
const DCI_CORPS_DATA = {
  ...
  "Blue Devils": {
    ...
    founded: 1957,
    colors: { primary: "navy blue", secondary: "silver", accent: "white" },
    defaultUniform: {
  ...
  "Carolina Crown": {
    ...
    founded: 1988,
    colors: { primary: "maroon", secondary: "gold", accent: "burgundy" },
    defaultUniform: {
  ...
  "Santa Clara Vanguard": {
    ...
    founded: 1967,
    colors: { primary: "scarlet red", secondary: "gold", accent: "white" },
    defaultUniform: {
  ...
  "Bluecoats": {
    ...
    founded: 1972,
    colors: { primary: "electric blue", secondary: "white", accent: "chrome" },
    defaultUniform: {
  ...
  "Phantom Regiment": {
    ...
    founded: 1956,
    colors: { primary: "maroon", secondary: "black", accent: "silver" },
    defaultUniform: {
  ...
  "Cavaliers": {
    ...
    founded: 1948,
    colors: { primary: "hunter green", secondary: "white", accent: "gold" },
    defaultUniform: {
    ...
    shows: {
      ...
      2023: { title: "...Where You'll Find Me" },
  ...
  "Madison Scouts": {
    ...
    founded: 1938,
    colors: { primary: "kelly green", secondary: "gold", accent: "white" },
    defaultUniform: {
  ...
  "Boston Crusaders": {
    ...
    founded: 1940,
    colors: { primary: "crimson red", secondary: "white", accent: "gold" },
    defaultUniform: {
  ...
  "Blue Stars": {
    ...
    founded: 1964,
    colors: { primary: "royal blue", secondary: "silver", accent: "white" },
    defaultUniform: {
  ...
  "Mandarins": {
    ...
    founded: 1963,
    colors: { primary: "crimson red", secondary: "gold", accent: "black" },
    defaultUniform: {
  ...
  "Troopers": {
    ...
    founded: 1957,
    colors: { primary: "tan", secondary: "brown", accent: "cavalry yellow" },
    defaultUniform: {
  ...
  "Colts": {
    ...
    founded: 1963,
    colors: { primary: "purple", secondary: "silver", accent: "white" },
    defaultUniform: {
  ...
  "Spirit of Atlanta": {
    ...
    founded: 1976,
    colors: { primary: "scarlet red", secondary: "gold", accent: "black" },
    defaultUniform: {
  ...
  "Blue Knights": {
    ...
    founded: 1958,
    colors: { primary: "royal blue", secondary: "chrome", accent: "white" },
    defaultUniform: {
  ...
  "Crossmen": {
    ...
    founded: 1974,
    colors: { primary: "royal blue", secondary: "white", accent: "silver" },
    defaultUniform: {
  ...
  "Pacific Crest": {
    ...
    founded: 1993,
    colors: { primary: "teal", secondary: "white", accent: "silver" },
    defaultUniform: {
  ...
  "The Academy": {
    ...
    founded: 2001,
    colors: { primary: "black", secondary: "yellow", accent: "silver" },
    defaultUniform: {
      uniform: "black with yellow and silver accents, Arizona sun-inspired modern design",
      helmet: "black helmet with yellow sunburst crest",
      brass: "silver brass with yellow valve caps",
      percussion: "black drums with yellow accents",
      guard: "black and yellow contemporary athletic costumes",
    },
    shows: {
  ...
  "Genesis": {
    ...
    defaultUniform: {
      uniform: "orange and black with Texas pride, bold contemporary design",
      helmet: "black helmet with orange accents and flame plume",
      brass: "silver brass with orange valve caps",
      percussion: "black drums with orange graphics",
      guard: "orange and black Texas-inspired athletic costumes",
    },
    shows: {
      2013: { title: "mOZaic" },
  ...
  "Music City": {
    ...
    defaultUniform: {
      uniform: "purple and gold Nashville-inspired design, music heritage aesthetic",
      helmet: "gold helmet with purple plume and musical note crest",
      brass: "gold brass with musical note engravings",
      percussion: "purple drums with gold Nashville graphics",
      guard: "purple and gold music-inspired costumes",
    },
    shows: {
  ...
  "Seattle Cascades": {
    ...
    defaultUniform: {
      uniform: "forest green with white Pacific Northwest mountain patterns",
      helmet: "green helmet with silver cascade mountain crest",
      brass: "silver brass with mountain and waterfall engravings",
      percussion: "green drums with white cascade graphics",
      guard: "Pacific Northwest green and white costumes with mountain elements",
    },
    shows: {
  ...
  "Spartans": {
    ...
    founded: 1955,
    colors: { primary: "crimson red", secondary: "gold", accent: "white" },
    defaultUniform: {
      uniform: "crimson red with gold Spartan warrior design, ancient Greece inspired",
      helmet: "gold Spartan helmet with red plume crest",
      brass: "gold brass with Spartan shield engravings",
      percussion: "red drums with gold Spartan graphics",
      guard: "Spartan warrior-inspired red and gold costumes",
    },
    shows: {
