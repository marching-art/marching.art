...
export const inviteDirectorToLeague = httpsCallable(functions, 'inviteDirectorToLeague');
export const respondToLeagueInvitation = httpsCallable(functions, 'respondToLeagueInvitation');
export const rescindLeagueInvitation = httpsCallable(functions, 'rescindLeagueInvitation');
