...
export const FAQ = [
  ...
  },
  {
    ...
    a: "Yes! Caption changes are unlimited for the first two weeks, through Day 14 at 8:00 PM ET. From Week 3 on you get 3 changes per week per class — use them one at a time or all at once. A corps doesn't rework its lineup after the show: changes lock every night at 8:00 PM ET and reopen at 2:00 AM ET, once that night's scores are final. Unused weekly changes expire at the Saturday 8:00 PM ET close. No changes are allowed on Days 43-44. During Championship Week (Days 45-49) each competing class gets 2 changes per day, resetting nightly at 8:00 PM ET — only Open and A Class compete on Days 45-46, all classes on Day 47, and World Class and SoundSport in the Days 48-49 Finals. That works out to the same 6 total changes for every class across the days it is guaranteed to compete, so it stays fair even if an Open or A Class corps advances to Finals.",
  },
  {
