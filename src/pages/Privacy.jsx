      ...
      <div className="bg-surface-card border border-line rounded-none p-6 sm:p-8">
        ...
        <div className="space-y-6 text-secondary">
          ...
          <section>
            ...
            <p className="text-sm mb-2">
              We and our service providers (including Google/YouTube) may store, access, or collect
              information directly or indirectly on or from your device by placing, accessing, or
              recognizing cookies or similar technologies on your device or browser.
            </p>
            ...
            <p className="text-sm mt-2">
              ...
              device. You can manage cookie preferences through your browser settings.
            </p>
          </section>
