...
const StyleGuide: React.FC = () => {
  useBodyScroll();
  // An internal design reference, not a product page: it was crawlable (absent
  // from the robots.txt disallow list) with no noindex of its own.
  useSEO({ title: 'Style Guide | marching.art', path: '/styleguide', noindex: true });
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="border-b border-line pb-5">
          ...
          <p className="mt-2 text-secondary">
            ...
            reward; azure is interaction and self; green/red/amber are data; everything else is
            quiet charcoal.
          </p>
        </header>
        ...
        <Section title="Gold: do &amp; don't">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="border border-line bg-surface-raised p-4">
              <div className="mb-2 text-xs font-bold uppercase tracking-wider text-error">
                Don't
              </div>
