// src/pages/ProfilePage.js - Enhanced with fantasy director features (Working Version)
                ...
                {activeTab === 'performance' && (
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-surface dark:bg-surface-dark rounded-theme border border-accent dark:border-accent-dark p-6">
                            ...
                            <p className="text-text-secondary dark:text-text-secondary-dark">
                                Detailed performance charts and analytics coming soon!
                            </p>
                        </div>
                        ...
                        <div className="bg-surface dark:bg-surface-dark rounded-theme border border-accent dark:border-accent-dark p-6">
                            ...
                            <p className="text-text-secondary dark:text-text-secondary-dark">
                                Historical score tracking and trends coming soon!
                            </p>
                        </div>
                    </div>
                )}
