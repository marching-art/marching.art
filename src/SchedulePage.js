...
const SchedulePage = () => {
    ...
    // NOTE: This function provides POST-EVENT attendance counts from recap data.
    // A true real-time registration count would require a different backend data source.
    ...
    // NEW: Check if scores exist for a given day before showing the button.
