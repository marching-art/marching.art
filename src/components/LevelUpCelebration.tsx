...
const LevelUpModal: React.FC<{
  ...
  return (
    ...
    >
      ...
      >
        {/* Glow effect */}
        <div className="absolute inset-0 bg-blue-500/20 blur-3xl rounded-none scale-150" />
        ...
        {data.classUnlocked && (
          <m.div
            ...
            className="flex items-center gap-3 px-6 py-3 bg-green-500/20 border border-green-500/50 rounded-none"
          >
