    ...
    <div className="max-w-md w-full bg-surface-card rounded-none border border-line p-8 text-center">
      ...
      <div className="flex gap-3 justify-center">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-transparent border border-white/20 text-white rounded-none font-semibold hover:bg-white/5 hover:border-white/40 transition-colors"
        >
