  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-3 bg-cream-50 dark:bg-charcoal-900/50 rounded-sm border border-cream-200 dark:border-cream-500/10">
      ...
      {isMember ? (
        <div className="flex items-center justify-between p-3 bg-green-500/10 border border-green-500/30 rounded-sm">
