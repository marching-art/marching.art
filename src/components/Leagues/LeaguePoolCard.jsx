      ...
      <div className="p-4 flex items-center gap-4">
        ...
        {resolved ? (
          ...
          <button
            onClick={handleJoin}
            disabled={joining}
            className="h-9 px-4 text-xs font-bold uppercase tracking-wider bg-yellow-600 hover:bg-yellow-500 disabled:bg-line text-white transition-colors press-feedback flex items-center gap-1.5"
          >
