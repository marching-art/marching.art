        ...
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-xs text-muted">
              ...
              {article.category && <span className="text-muted">{article.category}</span>}
            </div>
          </div>
        </div>
      </div>
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800 disabled:opacity-50 text-white text-sm font-medium rounded-none transition-colors flex-shrink-0"
...
const SectionEditor = ({ title, section, color }) => {
  ...
  return (
    <div className={`border rounded-none ${colorClasses[color]}`}>
      <button
        type="button"
        onClick={() => setExpanded(!expanded)}
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {section.title && <span className="text-xs text-muted">- {section.title}</span>}
        </div>
        {expanded ? (
...
export { ArticleRow, ArticleEditorModal, SectionEditor };
