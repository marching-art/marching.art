 ...
 * Dark glass theme with gold accents
 */
      ...
      <div className="glass-premium rounded-xl p-5">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-cream-100 truncate">
        ...
        {activeCorps && (
          <div className="hidden lg:flex items-center gap-4 mt-4 pt-4 border-t border-cream-500/10">
