...
const formatScore = (/** @type {unknown} */ score) => {
...
const formatDelta = (/** @type {unknown} */ delta) => {
...
const RivalsPanel = memo(
  /**
   * @param {{
   *   rivals?: Array<Record<string, any>>,
   *   corpsClass?: string,
   *   division?: string,
   * }} props
   */
  ({ rivals, corpsClass, division }) => {
