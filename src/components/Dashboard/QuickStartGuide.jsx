    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-2xl max-h-[85vh] bg-charcoal-900 border border-white/10 rounded-2xl overflow-hidden flex flex-col"
        >
          {/* Header */}
                    ...
                    {isExpanded && (
                      ...
                      >
                        <div className="px-4 pb-4 pt-0">
                          <div className="p-4 bg-charcoal-950/50 rounded-lg mb-3">
                          ...
                          {step.action.target === 'lineup' ? (
                            <button
                              ...
                              className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-charcoal-900 font-semibold ${colors.button} transition-colors`}
                            >
                              {step.action.label}
