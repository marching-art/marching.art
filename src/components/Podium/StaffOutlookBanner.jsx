...
export default function StaffOutlookBanner({ podium }) {
  ...
  return (
    <div className="bg-[#2a1a0a] border border-[#8a5a1a] rounded-none p-4 space-y-2">
      <div className="flex items-start gap-2">
        <AlertTriangle className="w-4 h-4 shrink-0 mt-0.5 text-[#e0a020]" />
      ...
      <div className="flex justify-end">
        <button
          onClick={acknowledge}
          disabled={dismissing}
          className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-none border border-[#8a5a1a] text-[#f0c060] hover:bg-[#3a2510] disabled:opacity-60 press-feedback"
        >
