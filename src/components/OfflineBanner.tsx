          ...
          <div className="bg-red-500/95 border-b border-red-400/50">
            <div className="container-responsive py-2 px-4">
              <div className="flex items-center justify-center gap-3">
                ...
                {/* Keep this honest: reads come from the local cache and
                    lineup saves queue for replay (offlineLineupQueue), but
                    other writes still need a connection */}
                <span className="text-xs text-white/80 hidden sm:inline">
                  — Browsing works from cache; lineup saves submit on reconnect
                </span>
                <button
          ...
          <div className="bg-green-500/95 border-b border-green-400/50">
            <div className="container-responsive py-2 px-4">
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-sm font-semibold text-white">Back online</span>
                <span className="text-xs text-white/80 hidden sm:inline">
            ...
            <div className="container-responsive py-2 px-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold text-white">Slow connection detected</span>
                  <span className="text-xs text-white/80 hidden sm:inline">
