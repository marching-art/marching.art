    ...
    >
      ...
      <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-sm p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-black/30 border border-yellow-500/20 rounded-sm p-4 text-center shadow-[0_0_15px_rgba(234,179,8,0.1)]">
          ...
          <div className="bg-black/30 border border-blue-500/20 rounded-sm p-4 text-center shadow-[0_0_15px_rgba(59,130,246,0.1)]">
          ...
          <div className="bg-black/30 border border-purple-500/20 rounded-sm p-4 text-center shadow-[0_0_15px_rgba(168,85,247,0.1)]">
          ...
          <div className="bg-black/30 border border-green-500/20 rounded-sm p-4 text-center shadow-[0_0_15px_rgba(74,222,128,0.1)]">
        ...
        <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-sm p-6">
          ...
          <div className="space-y-4">
            {Object.entries(profile.corps).map(([classKey, corps]) => {
              ...
              return (
                <div key={classKey} className="bg-black/30 rounded-sm p-4 border border-white/5">
                  ...
                  <div className="w-full bg-black/50 rounded-sm h-3">
                    <div
                      className="bg-gradient-to-r from-blue-500 to-yellow-400 h-3 rounded-sm transition-all shadow-[0_0_10px_rgba(234,179,8,0.3)]"
      ...
      <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {profile.createdAt && (
            <div className="bg-black/30 border border-white/5 rounded-sm p-4 md:col-span-2">
