          ...
          {actions.map((item) => {
            ...
            return (
              <Link
                ...
                className={`relative flex flex-col items-center justify-center gap-0.5 px-1 xs:px-2 py-1.5 min-w-[44px] xs:min-w-[50px] min-h-[48px] press-feedback rounded-sm ${
                  item.emphasized ? 'bg-yellow-500/10' : ''
                }`}
              >
                <div
                  className={`relative z-10 p-1.5 rounded-sm transition-all duration-150 ${
