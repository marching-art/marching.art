...
if [ $# -eq 0 ]; then
    ...
    echo "  Leagues: createLeague, joinLeague, leaveLeague, generateMatchups, updateMatchupResults"
    echo "  Leagues: proposeStaffTrade, respondToStaffTrade, postLeagueMessage"
    ...
    echo "  Triggers: processDciScores, processLiveScoreRecap"
